...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="py-10 bg-[#141414] sm:pt-16 lg:pt-40 ">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">

                    <div className="sm:py-12 pt-[10rem]">
                        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                            <div className="text-center space-y-12 xl:flex xl:items-center xl:justify-between xl:text-left">
