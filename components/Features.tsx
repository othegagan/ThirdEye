...
const Features = () => {
    ...
    // Example: Accessing data for the first strategy
    console.log(educationStrategies[0].title); // Output: "Equitable Access to Resources"
    console.log(educationStrategies[0].description); // Output: "Share educational resources to ensure that all students have access to quality learning materials."
        ...
        <section className="py-10 bg-gray-50 sm:py-16 lg:py-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-3xl mx-auto text-center">
                    <p className='text-primary font-extrabold uppercase text-[1.25rem] leading-3 mb-[1.5rem]'>Features</p>
                    <h2 className="text-3xl font-bold  text-black sm:text-4xl ">We are always working to provide best of the all features in all aspects.</h2>
                    <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">Install our top-rated dropshipping app to your e-commerce site and get access to US Suppliers, AliExpress vendors, and the best.</p>
                </div>

                <div className="grid grid-cols-1 gap-6 mt-12 lg:mt-16 xl:gap-10 sm:grid-cols-2 lg:grid-cols-3">

                    {educationStrategies.map((item) => (
                        <div key={item.id} className={`overflow-hidden h-min ${item.id % 2 === 0 ? "bg-white" : "bg-primary/10"
                            ...
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center">
                                    ...
                                    <div className='h-12 w-12 rounded-md bg-zinc-700'></div>
                                    <p className="ml-5 mr-auto text-xl font-semibold text-[#141414]">{item.title}</p>
                                </div>
                                <p className="text-base leading-relaxed text-[#1E1E1E]">{item.description}</p>
                            </div>
                        </div>
